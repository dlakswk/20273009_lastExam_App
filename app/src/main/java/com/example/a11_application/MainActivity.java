    ...
    public void InitalLizeListenner() {
        callbackMethon = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int dayOfMonth) {
                ...
                editText.setText("https://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=ab9c2dcf5097608c8f8cf078b67c7046&targetDt=" + date);
            }
        };
    }

    public void dataProcess(View v) {
        DatePickerDialog dialog = new DatePickerDialog(this, callbackMethon, 2021, 11, 20);
        dialog.show();
    }
